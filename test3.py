import sys
from PyQt6.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QSizePolicy, QTabWidget, QMenu
...
class MultiRowTabWidget(QWidget):
    ...
    def add_tab(self, widget, title):
        ...
        button.setContextMenuPolicy(Qt.ContextMenuPolicy.CustomContextMenu)  # CustomContextMenu policy
        button.customContextMenuRequested.connect(lambda point: self.show_menu(point, button))
